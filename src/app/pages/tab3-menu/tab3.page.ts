...
import { speedometer,flag,podium,person,newspaper,wallet,ticket,gift } from 'ionicons/icons';
...
export class Tab3Page {
  ...
  constructor(private auth:AuthService, private user:UsersService, private global:GlobalService) {
    addIcons({ speedometer,flag,podium,person,newspaper,wallet,ticket,gift});
  }
